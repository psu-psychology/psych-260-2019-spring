---
title: "260-2019-04-23-speed-lab"
author: PSYCH 260.001
date: "`r Sys.time()`"
...
- Data file with [body measurements](https://docs.google.com/spreadsheets/d/1HGZfc31OxC8Vso6qCBuW5d89hFhUh0sooY-p8A-J_t8/edit?usp=sharing)
    + participant, ankleshoulder (cm)
- Data file with [reaction times](https://docs.google.com/spreadsheets/d/1HGZfc31OxC8Vso6qCBuW5d89hFhUh0sooY-p8A-J_t8/edit#gid=1626241513)
...
```{r load-distance}
psych260 <- gs_title("psych-260-2019-spring")
psych260 %>% 
  gs_read(ws = "distance") %>%
...
This document was prepared in RStudio 1.1.453 on `r Sys.time()`.
